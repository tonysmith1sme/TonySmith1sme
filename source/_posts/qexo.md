...
![](./img/截屏2022-07-06 09.22.57.png)

然后套餐选择免费

![](./img/截屏2022-07-06 09.24.04.png)

![](./img/截屏2022-07-06 09.25.19.png)

点击创建，然后要你设置连接数据库用的用户名和密码

![](./img/截屏2022-07-06 09.27.11.png)

设置好之后到左侧栏的Database，记住你数据库的名字，我的就直接默认Cluster0

![](./img/截屏2022-07-06 09.29.12.png)

点击Connect

![](./img/截屏2022-07-06 09.29.50.png)

![](./img/截屏2022-07-06 09.30.43.png)

![](./img/截屏2022-07-06 09.31.38.png)

![](./img/截屏2022-07-06 09.32.27.png)

![](./img/截屏2022-07-06 09.35.01.png)
...
![](./img/截屏2022-07-06 09.09.58.png)

克隆的名称随便填

第一次部署会出现错误，因为我们还没有设置**环境变量**

![](./img/截屏2022-07-06 09.12.49.png)

到Vercel的项目设置 -> *Environment Variables*

![](./img/截屏2022-07-06 09.16.07.png)
...
![](./img/截屏2022-07-06 09.40.51.png)

选择里面部署错误的那一项，选*Redeploy*

![](./img/截屏2022-07-06 09.41.30.png)

![](./img/截屏2022-07-06 09.41.36.png)

过一会就能顺利看见后台初始化向导了

![](./img/截屏2022-07-06 09.44.11.png)
...
![](./img/截屏2022-07-06 09.46.13.png)

仓库名称、分支、路径这些的你应该知道怎么填的

密钥要到你的[Github 设置](https://github.com/settings/tokens)去生成一个

![](./img/截屏2022-07-06 09.48.46.png)

![](./img/截屏2022-07-06 09.49.19.png)
...
![](./img/截屏2022-07-06 09.52.43.png)

然后填Project ID，前往你的Qexo项目设置

![](./img/截屏2022-07-06 09.54.07.png)

鼠标滑到最下面就可以看到了

![](./img/截屏2022-07-06 09.54.13.png)

# 结尾

至此，恭喜你有了一个基于Qexo的Hexo后台，它可以帮助你更方便的进行写作

![](./img/截屏2022-07-06 09.55.45.png)

同时，在这里说一下，如果Qexo有缓存不刷新（比如文章列表不出来新文章之类的）就到左上角的齿轮进入设置

![](./img/截屏2022-07-06 09.57.07.png)
